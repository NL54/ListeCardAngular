...
export class MonsterService {
  ...
  private init(){
    ...
    monster2.id=this.currentIndex;
 		monster2.name = "Car";
 		monster2.image = "./monster/TCG Creature Cards - Borderless (200).png";
    ...
    monster3.id=this.currentIndex;
 		monster3.name = "Bulb";
 		monster3.image = "./monster/TCG Creature Cards - Borderless (202).png";
    ...
    monster4.id=this.currentIndex;
 		monster4.name = "Sala";
 		monster4.image = "./monster/TCG Creature Cards - Borderless (203).png";
